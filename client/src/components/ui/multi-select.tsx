...
const multiSelectVariants = cva(
  'm-1 border border-border/50 bg-muted/20 text-foreground shadow-sm transition-colors duration-200 ease-out',
  {
    variants: {
      variant: {
        default: '',
        secondary: 'bg-surface text-muted border-border/40',
        destructive: 'bg-error/10 text-error border-error/40',
        inverted: 'bg-foreground text-background border-foreground',
      },
      badgeAnimation: {
        bounce: 'hover:-translate-y-0.5 hover:scale-105',
        pulse: 'hover:animate-pulse',
        wiggle: 'hover:-rotate-1 hover:scale-105',
            ...
            >
              {selectedValues.length > 0 ? (
                <div className="flex justify-between items-center w-full">
                  ...
                  >
                        ...
                        return (
                          ...
                          >
                            {IconComponent && !responsiveSettings.hideIcons && (
                              <IconComponent
                                className={cn(
                                  'mr-1.5 h-4 w-4 text-muted-foreground',
                                  responsiveSettings.compactMode &&
                                    'mr-1 h-3 w-3',
                            ...
                            <div
                              ...
                              className="ml-1.5 mr-0.5 flex h-4 w-4 items-center justify-center rounded-sm p-0.5 transition-colors hover:bg-muted/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
                            >
                              <XCircle
                                className={cn(
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        className={cn(
                          'gap-1 bg-muted/10 text-muted-foreground border-dashed border-border/40 pr-1 hover:bg-muted/20',
                          getBadgeAnimationClass(),
                          responsiveSettings.compactMode &&
                            'gap-0.5 px-1.5 py-0.5 text-xs',
                          singleLine && 'flex-shrink-0 whitespace-nowrap',
                      ...
                      >
                        ...
                        <XCircle
                          className={cn(
                            'ml-1.5 h-4 w-4 cursor-pointer text-muted-foreground transition-colors hover:text-foreground',
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="mx-2 flex h-4 w-4 items-center justify-center rounded-sm text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1"
                    >
                    ...
                    />
                    <ChevronDown
                      className="mx-2 h-4 cursor-pointer text-muted-foreground/80"
                      aria-hidden="true"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between w-full mx-auto">
                  ...
                  <ChevronDown className="mx-2 h-4 cursor-pointer text-muted-foreground/80" />
                </div>
              )}
            </Button>
          </PopoverTrigger>
